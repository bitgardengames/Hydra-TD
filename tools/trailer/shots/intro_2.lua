...
return {
	...
	scene = {
		towers = {
			...
			{kind = "shock", gx = 20, gy = 10},
			{kind = "cannon", gx = 19, gy = 9},
			{kind = "lancer", gx = 17, gy = 12},
		},
	...
	camera = Camera.pan({
		duration = 7.0,
		from = {x = mapCX + adjustX, y = mapCY + adjustY, zoom = 3},
		to = {x = mapCX + adjustX, y = mapCY + adjustY, zoom = 3}
	}),
}