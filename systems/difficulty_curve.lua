...
-- Campaign durability reaches its cap at the midpoint boss; waves 11-20 add
-- authored composition pressure instead of hidden stat inflation. Map progression is
...
DifficultyCurve.durabilityRampEnd = 10
...
function DifficultyCurve.getEnemyHpMultiplier(waveIndex, mapIndex, authoredScalar)
	...
	local localWave = math.min(waveIndex, DifficultyCurve.durabilityRampEnd)
	local progress = (localWave - 1) / (DifficultyCurve.durabilityRampEnd - 1)
