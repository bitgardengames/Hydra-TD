...
local wavesByMapId = {
	...
	terrace = {
		...
		[8] = { g("warcaller", 8, 0.60), g("grunt", 7, 0.50, 0.22), g("tank", 9, 0.55, 0.43), g("runner", 10, 0.50, 0.65) },
		-- 6 warcallers, then 7 regenerators, then 8 bulwarks, then 8 runners, and 9 tanks.
		[9] = { g("warcaller", 6, 0.60), g("regenerator", 7, 0.60, 0.14), g("bulwark", 8, 1.17, 0.36), g("runner", 8, 0.50, 0.58), g("tank", 9, 0.57, 0.72) },
		...
		[13] = { g("warcaller", 9, 0.60), g("grunt", 8, 0.50, 0.22), g("tank", 10, 0.55, 0.43), g("runner", 11, 0.50, 0.65) },
		[14] = { g("warcaller", 7, 0.60), g("regenerator", 8, 0.60, 0.21), g("bulwark", 8, 1.19, 0.47), g("runner", 9, 0.57, 0.68) },
		[15] = { g("warcaller", 7, 0.60), g("regenerator", 8, 0.60, 0.15), g("bulwark", 9, 1.17, 0.38), g("runner", 9, 0.50, 0.61), g("tank", 10, 0.57, 0.76) },
		[16] = { g("warcaller", 12, 0.60), g("regenerator", 11, 0.61, 0.32), g("bulwark", 16, 1.35, 0.65) },
		[17] = { g("warcaller", 10, 0.60), g("grunt", 8, 0.50, 0.20), g("tank", 11, 0.55, 0.39), g("runner", 12, 0.50, 0.59) },
		[18] = { g("warcaller", 8, 0.60), g("regenerator", 9, 0.60, 0.19), g("bulwark", 9, 1.19, 0.42), g("runner", 10, 0.57, 0.61) },
		[19] = { g("warcaller", 8, 0.60), g("regenerator", 9, 0.60, 0.12), g("bulwark", 10, 1.17, 0.31), g("runner", 10, 0.50, 0.49), g("tank", 11, 0.57, 0.61) },
	...
	highridge = {
		...
		[8] = { g("warcaller", 8, 0.60), g("bulwark", 4, 1.21, 0.36), g("runner", 5, 0.50, 0.66), g("grunt", 9, 0.58, 0.72), g("tank", 10, 0.69, 1.08) },
		...
		[13] = { g("warcaller", 9, 0.60), g("bulwark", 4, 1.21, 0.36), g("runner", 6, 0.50, 0.66), g("grunt", 10, 0.58, 0.72), g("tank", 11, 0.69, 1.08) },
		...
		[17] = { g("warcaller", 10, 0.60), g("bulwark", 5, 1.21, 0.32), g("runner", 6, 0.50, 0.59), g("grunt", 11, 0.58, 0.65), g("tank", 12, 0.69, 0.97) },
	...
	tidelock = {
		...
		[8] = { g("warcaller", 7, 0.77), g("tank", 11, 0.59, 0.40), g("regenerator", 9, 0.70, 0.46) },
		[9] = { g("runner", 15, 0.50), g("summoner", 2, 1.44, 0.38), g("bulwark", 10, 1.28, 0.42) },
		[10] = { g("boss", 1, 0.00), g("warcaller", 8, 0.74, 1.30), g("runner", 15, 0.50, 0.66), g("regenerator", 9, 0.68, 0.58) },
		...
		[13] = { g("warcaller", 9, 0.72), g("runner", 17, 0.50, 0.32), g("tank", 13, 0.57, 0.38) },
		[14] = { g("summoner", 3, 1.37), g("bulwark", 12, 1.21, 0.36), g("regenerator", 11, 0.66, 0.34) },
		[15] = { g("runner", 18, 0.50), g("warcaller", 10, 0.70, 0.30), g("tank", 14, 0.55, 0.32) },
		[16] = { g("regenerator", 12, 0.64), g("summoner", 3, 1.30, 0.32), g("bulwark", 13, 1.17, 0.30) },
		[17] = { g("warcaller", 11, 0.67), g("runner", 19, 0.50, 0.28), g("grunt", 18, 0.50, 0.26) },
		[18] = { g("summoner", 3, 1.22), g("tank", 15, 0.55, 0.28), g("regenerator", 13, 0.62, 0.26) },
		[19] = { g("runner", 20, 0.50), g("warcaller", 12, 0.65, 0.25), g("bulwark", 14, 1.17, 0.24), g("summoner", 3, 1.15, 0.24) },
		[20] = { g("boss", 1, 0.00), g("summoner", 3, 1.12, 1.10), g("runner", 20, 0.50, 0.52), g("warcaller", 12, 0.62, 0.46), g("bulwark", 14, 1.17, 0.42) },
	},
	ashspiral = {
		[1] = { g("grunt", 18, 0.52), g("runner", 8, 0.50, 0.30) },
		[2] = { g("tank", 10, 0.61), g("bulwark", 7, 1.31, 0.28) },
		[3] = { g("warcaller", 6, 0.74), g("regenerator", 7, 0.68, 0.26), g("runner", 10, 0.50, 0.24) },
		[4] = { g("summoner", 2, 1.37), g("grunt", 14, 0.50, 0.24), g("tank", 10, 0.57, 0.22) },
		[5] = { g("bulwark", 9, 1.24), g("runner", 13, 0.50, 0.22), g("warcaller", 7, 0.70, 0.20) },
		[6] = { g("regenerator", 9, 0.64), g("tank", 12, 0.55, 0.20), g("summoner", 2, 1.26, 0.20) },
		[7] = { g("runner", 15, 0.50), g("bulwark", 10, 1.21, 0.18), g("warcaller", 8, 0.67, 0.18) },
		[8] = { g("summoner", 3, 1.22), g("regenerator", 10, 0.62, 0.18), g("grunt", 17, 0.50, 0.16) },
		[9] = { g("tank", 13, 0.55), g("runner", 17, 0.50, 0.16), g("warcaller", 9, 0.65, 0.16) },
		[10] = { g("boss", 1, 0.00), g("summoner", 3, 1.15, 0.90), g("bulwark", 11, 1.17, 0.38), g("runner", 17, 0.50, 0.34), g("regenerator", 10, 0.60, 0.30) },
		[11] = { g("warcaller", 10, 0.62), g("tank", 14, 0.55, 0.15), g("runner", 18, 0.50, 0.15) },
		[12] = { g("summoner", 3, 1.12), g("regenerator", 11, 0.60, 0.15), g("bulwark", 12, 1.17, 0.14) },
		[13] = { g("runner", 19, 0.50), g("grunt", 20, 0.50, 0.14), g("warcaller", 11, 0.60, 0.14) },
		[14] = { g("tank", 15, 0.55), g("summoner", 4, 1.08, 0.14), g("regenerator", 12, 0.60, 0.13) },
		[15] = { g("bulwark", 13, 1.17), g("runner", 20, 0.50, 0.13), g("warcaller", 12, 0.60, 0.13) },
		[16] = { g("summoner", 4, 1.04), g("tank", 16, 0.55, 0.12), g("regenerator", 13, 0.60, 0.12) },
		[17] = { g("runner", 21, 0.50), g("bulwark", 14, 1.17, 0.12), g("warcaller", 13, 0.60, 0.11) },
		[18] = { g("regenerator", 14, 0.60), g("summoner", 4, 1.01, 0.11), g("tank", 17, 0.55, 0.11) },
		[19] = { g("warcaller", 14, 0.60), g("runner", 22, 0.50, 0.10), g("bulwark", 15, 1.17, 0.10), g("summoner", 4, 0.97, 0.10) },
		[20] = { g("boss", 1, 0.00), g("summoner", 4, 0.94, 0.72), g("warcaller", 14, 0.60, 0.28), g("regenerator", 14, 0.60, 0.25), g("bulwark", 15, 1.17, 0.22), g("runner", 22, 0.50, 0.20) },
	},
}
