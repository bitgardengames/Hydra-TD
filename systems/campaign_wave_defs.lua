...
local wavesByMapId = {
	...
	lowvalley = {
		...
		[6] = { g("bulwark", 10, 1.22), g("runner", 9, 0.63, 0.72), g("tank", 13, 0.79, 1.45) },
		-- 6 bulwarks, then 7 runners, then 7 tanks, and 9 grunts.
		[7] = { g("bulwark", 6, 1.17), g("runner", 7, 0.56, 0.43), g("tank", 7, 0.68, 1.01), g("grunt", 9, 0.71, 1.45) },
		-- 8 grunts, then 8 tanks, then 9 runners, and 11 bulwarks.
		[8] = { g("grunt", 8, 0.50), g("tank", 8, 0.55, 0.43), g("runner", 9, 0.56, 0.87), g("bulwark", 11, 1.39, 1.30) },
		-- 7 bulwarks, then 8 runners, then 9 tanks, and 9 grunts.
		[9] = { g("bulwark", 7, 1.17), g("runner", 8, 0.50, 0.29), g("tank", 9, 0.57, 0.72), g("grunt", 9, 0.59, 1.16) },
		-- 1 boss, then 7 bulwarks, then 7 runners, then 8 tanks, and 8 grunts.
		[10] = { g("boss", 1, 0.00), g("bulwark", 7, 1.17, 2.61), g("runner", 7, 0.52, 2.90), g("tank", 8, 0.65, 3.33), g("grunt", 8, 0.67, 3.62) },
		[11] = { g("bulwark", 6, 1.17), g("runner", 8, 0.56, 0.47), g("tank", 8, 0.68, 1.11), g("grunt", 10, 0.71, 1.59) },
		[12] = { g("bulwark", 11, 1.22), g("runner", 10, 0.63, 0.76), g("tank", 15, 0.79, 1.52) },
		[13] = { g("grunt", 9, 0.50), g("tank", 9, 0.55, 0.43), g("runner", 10, 0.56, 0.87), g("bulwark", 12, 1.39, 1.30) },
		[14] = { g("bulwark", 7, 1.17), g("runner", 8, 0.56, 0.41), g("tank", 8, 0.68, 0.96), g("grunt", 10, 0.71, 1.38) },
		[15] = { g("bulwark", 8, 1.17), g("runner", 9, 0.50, 0.30), g("tank", 10, 0.57, 0.76), g("grunt", 10, 0.59, 1.22) },
		[16] = { g("bulwark", 12, 1.22), g("runner", 11, 0.63, 0.65), g("tank", 16, 0.79, 1.30) },
		[17] = { g("grunt", 10, 0.50), g("tank", 10, 0.55, 0.39), g("runner", 11, 0.56, 0.78), g("bulwark", 13, 1.39, 1.17) },
		[18] = { g("bulwark", 8, 1.17), g("runner", 9, 0.56, 0.37), g("tank", 9, 0.68, 0.86), g("grunt", 12, 0.71, 1.23) },
		[19] = { g("bulwark", 9, 1.17), g("runner", 10, 0.50, 0.25), g("tank", 11, 0.57, 0.61), g("grunt", 11, 0.59, 0.99) },
		[20] = { g("boss", 1, 0.00), g("bulwark", 9, 1.17, 2.35), g("runner", 9, 0.52, 2.61), g("tank", 10, 0.65, 3.00), g("grunt", 10, 0.67, 3.26) },
	},
	circuit = {
		-- 17 grunts.
		[1] = { g("grunt", 17, 0.70) },
		...
		[7] = { g("regenerator", 6, 0.60), g("bulwark", 7, 1.17, 0.20), g("runner", 7, 0.56, 0.45), g("tank", 8, 0.68, 0.65) },
		...
		[9] = { g("regenerator", 6, 0.60), g("bulwark", 7, 1.17, 0.13), g("runner", 9, 0.50, 0.33), g("tank", 9, 0.57, 0.52), g("grunt", 10, 0.57, 0.65) },
		-- 1 boss, then 6 regenerators, then 7 bulwarks, then 8 runners, and 8 tanks.
		[10] = { g("boss", 1, 0.00), g("regenerator", 6, 0.60, 1.17), g("bulwark", 7, 1.17, 1.30), g("runner", 8, 0.53, 1.49), g("tank", 8, 0.65, 1.62) },
		[11] = { g("regenerator", 6, 0.60), g("bulwark", 8, 1.17, 0.22), g("runner", 8, 0.56, 0.50), g("tank", 9, 0.68, 0.72) },
		...
		[14] = { g("regenerator", 7, 0.60), g("bulwark", 8, 1.17, 0.19), g("runner", 8, 0.56, 0.43), g("tank", 9, 0.68, 0.62) },
		[15] = { g("regenerator", 7, 0.60), g("bulwark", 8, 1.17, 0.14), g("runner", 10, 0.50, 0.35), g("tank", 10, 0.57, 0.55), g("grunt", 11, 0.57, 0.68) },
		...
		[18] = { g("regenerator", 8, 0.60), g("bulwark", 9, 1.17, 0.17), g("runner", 9, 0.56, 0.38), g("tank", 10, 0.68, 0.55) },
		[19] = { g("regenerator", 8, 0.60), g("bulwark", 9, 1.17, 0.11), g("runner", 11, 0.50, 0.28), g("tank", 11, 0.57, 0.44), g("grunt", 13, 0.57, 0.55) },
		[20] = { g("boss", 1, 0.00), g("regenerator", 8, 0.60, 1.05), g("bulwark", 9, 1.17, 1.17), g("runner", 10, 0.53, 1.34), g("tank", 10, 0.65, 1.46) },
	},
	outerloop = {
	...
	terrace = {
		...
		[6] = { g("warcaller", 10, 0.50), g("regenerator", 9, 0.61, 0.36), g("bulwark", 13, 1.35, 0.72) },
		-- 6 warcallers, then 7 regenerators, then 7 bulwarks, and 8 runners.
		[7] = { g("warcaller", 6, 0.50), g("regenerator", 7, 0.60, 0.22), g("bulwark", 7, 1.19, 0.50), g("runner", 8, 0.57, 0.72) },
		...
		[9] = { g("warcaller", 6, 0.50), g("regenerator", 7, 0.60, 0.14), g("bulwark", 8, 1.17, 0.36), g("runner", 8, 0.50, 0.58), g("tank", 9, 0.57, 0.72) },
		-- 1 boss, then 6 warcallers, then 7 regenerators, then 8 bulwarks, and 7 runners.
		[10] = { g("boss", 1, 0.00), g("warcaller", 6, 0.50, 1.30), g("regenerator", 7, 0.60, 1.44), g("bulwark", 8, 1.17, 1.66), g("runner", 7, 0.54, 1.80) },
		[11] = { g("warcaller", 6, 0.50), g("regenerator", 8, 0.60, 0.24), g("bulwark", 8, 1.19, 0.55), g("runner", 9, 0.57, 0.79) },
		[12] = { g("warcaller", 11, 0.50), g("regenerator", 10, 0.61, 0.38), g("bulwark", 15, 1.35, 0.76) },
		[13] = { g("warcaller", 9, 0.50), g("grunt", 8, 0.50, 0.22), g("tank", 10, 0.55, 0.43), g("runner", 11, 0.50, 0.65) },
		[14] = { g("warcaller", 7, 0.50), g("regenerator", 8, 0.60, 0.21), g("bulwark", 8, 1.19, 0.47), g("runner", 9, 0.57, 0.68) },
		[15] = { g("warcaller", 7, 0.50), g("regenerator", 8, 0.60, 0.15), g("bulwark", 9, 1.17, 0.38), g("runner", 9, 0.50, 0.61), g("tank", 10, 0.57, 0.76) },
		[16] = { g("warcaller", 12, 0.50), g("regenerator", 11, 0.61, 0.32), g("bulwark", 16, 1.35, 0.65) },
		[17] = { g("warcaller", 10, 0.50), g("grunt", 8, 0.50, 0.20), g("tank", 11, 0.55, 0.39), g("runner", 12, 0.50, 0.59) },
		[18] = { g("warcaller", 8, 0.50), g("regenerator", 9, 0.60, 0.19), g("bulwark", 9, 1.19, 0.42), g("runner", 10, 0.57, 0.61) },
		[19] = { g("warcaller", 8, 0.50), g("regenerator", 9, 0.60, 0.12), g("bulwark", 10, 1.17, 0.31), g("runner", 10, 0.50, 0.49), g("tank", 11, 0.57, 0.61) },
		[20] = { g("boss", 1, 0.00), g("warcaller", 8, 0.50, 1.17), g("regenerator", 9, 0.60, 1.30), g("bulwark", 10, 1.17, 1.49), g("runner", 9, 0.54, 1.62) },
	},
	highridge = {
		-- 17 grunts.
		[1] = { g("grunt", 17, 0.78) },
		...
		[5] = { g("warcaller", 10, 0.74), g("bulwark", 4, 1.46, 0.84), g("runner", 4, 0.53, 1.14) },
		-- 6 bulwarks, then 6 runners, then 10 warcallers, and 13 regenerators.
		[6] = { g("bulwark", 6, 1.26), g("runner", 6, 0.50, 0.30), g("warcaller", 10, 0.66, 0.60), g("regenerator", 13, 0.87, 1.20) },
		-- 3 bulwarks, then 4 runners, then 7 warcallers, then 7 regenerators, and 8 bulwarks.
		[7] = { g("bulwark", 3, 1.19), g("runner", 4, 0.50, 0.30), g("warcaller", 7, 0.58, 0.36), g("regenerator", 7, 0.76, 0.84), g("bulwark", 8, 1.60, 1.20) },
		-- 8 warcallers, then 4 bulwarks, then 5 runners, then 9 grunts, and 10 tanks.
		[8] = { g("warcaller", 8, 0.50), g("bulwark", 4, 1.21, 0.36), g("runner", 5, 0.50, 0.66), g("grunt", 9, 0.58, 0.72), g("tank", 10, 0.69, 1.08) },
		-- 4 bulwarks, then 4 runners, then 8 warcallers, then 9 regenerators, then 8 bulwarks, and 10 runners.
		[9] = { g("bulwark", 4, 1.17), g("runner", 4, 0.50, 0.30), g("warcaller", 8, 0.50, 0.24), g("regenerator", 9, 0.64, 0.60), g("bulwark", 8, 1.37, 0.96), g("runner", 10, 0.68, 1.20) },
		-- 1 boss, then 4 bulwarks, then 4 runners, then 7 warcallers, then 8 regenerators, and 8 bulwarks.
		[10] = { g("boss", 1, 0.00), g("bulwark", 4, 1.17, 2.16), g("runner", 4, 0.50, 2.46), g("warcaller", 7, 0.54, 2.40), g("regenerator", 8, 0.72, 2.76), g("bulwark", 8, 1.53, 3.00) },
		[11] = { g("bulwark", 3, 1.19), g("runner", 4, 0.50, 0.33), g("warcaller", 8, 0.58, 0.40), g("regenerator", 8, 0.76, 0.92), g("bulwark", 9, 1.60, 1.32) },
		[12] = { g("bulwark", 7, 1.26), g("runner", 7, 0.50, 0.32), g("warcaller", 11, 0.66, 0.63), g("regenerator", 15, 0.87, 1.26) },
		[13] = { g("warcaller", 9, 0.50), g("bulwark", 4, 1.21, 0.36), g("runner", 6, 0.50, 0.66), g("grunt", 10, 0.58, 0.72), g("tank", 11, 0.69, 1.08) },
		[14] = { g("bulwark", 3, 1.19), g("runner", 5, 0.50, 0.28), g("warcaller", 8, 0.58, 0.34), g("regenerator", 8, 0.76, 0.80), g("bulwark", 9, 1.60, 1.14) },
		[15] = { g("bulwark", 4, 1.17), g("runner", 4, 0.50, 0.32), g("warcaller", 9, 0.50, 0.25), g("regenerator", 10, 0.64, 0.63), g("bulwark", 9, 1.37, 1.01), g("runner", 11, 0.68, 1.26) },
		[16] = { g("bulwark", 7, 1.26), g("runner", 7, 0.50, 0.27), g("warcaller", 12, 0.66, 0.54), g("regenerator", 16, 0.87, 1.08) },
		[17] = { g("warcaller", 10, 0.50), g("bulwark", 5, 1.21, 0.32), g("runner", 6, 0.50, 0.59), g("grunt", 11, 0.58, 0.65), g("tank", 12, 0.69, 0.97) },
		[18] = { g("bulwark", 4, 1.19), g("runner", 5, 0.50, 0.26), g("warcaller", 9, 0.58, 0.31), g("regenerator", 9, 0.76, 0.71), g("bulwark", 10, 1.60, 1.02) },
		[19] = { g("bulwark", 5, 1.17), g("runner", 5, 0.50, 0.26), g("warcaller", 10, 0.50, 0.20), g("regenerator", 11, 0.64, 0.51), g("bulwark", 10, 1.37, 0.82), g("runner", 13, 0.68, 1.02) },
		[20] = { g("boss", 1, 0.00), g("bulwark", 5, 1.17, 1.94), g("runner", 5, 0.50, 2.21), g("warcaller", 9, 0.54, 2.16), g("regenerator", 10, 0.72, 2.48), g("bulwark", 10, 1.53, 2.70) },
	},
	crossflow = {
		-- 19 grunts.
		[1] = { g("grunt", 19, 0.56) },
		...
		[5] = { g("warcaller", 11, 0.55), g("bulwark", 4, 1.17, 0.23), g("runner", 4, 0.50, 0.53) },
		-- 6 bulwarks, then 7 runners, then 10 warcallers, and 13 regenerators.
		[6] = { g("bulwark", 6, 1.17), g("runner", 7, 0.50, 0.30), g("warcaller", 10, 0.50, 0.15), g("regenerator", 13, 0.67, 0.37) },
		-- 3 bulwarks, then 4 runners, then 7 warcallers, then 7 regenerators, and 8 bulwarks.
		[7] = { g("bulwark", 3, 1.17), g("runner", 4, 0.50, 0.30), g("warcaller", 7, 0.50, 0.08), g("regenerator", 7, 0.60, 0.23), g("bulwark", 8, 1.24, 0.37) },
		-- 4 bulwarks, then 5 runners, then 8 grunts, then 9 tanks, and 10 runners.
		[8] = { g("bulwark", 4, 1.17), g("runner", 5, 0.50, 0.30), g("grunt", 8, 0.50, 0.08), g("tank", 9, 0.55, 0.19), g("runner", 10, 0.50, 0.33) },
		-- 3 bulwarks, then 4 runners, then 7 warcallers, then 8 regenerators, then 8 bulwarks, and 9 runners.
		[9] = { g("bulwark", 3, 1.17), g("runner", 4, 0.50, 0.30), g("warcaller", 7, 0.50, 0.08), g("regenerator", 8, 0.60, 0.15), g("bulwark", 8, 1.17, 0.28), g("runner", 9, 0.50, 0.37) },
		-- 1 boss, then 4 bulwarks, then 4 runners, then 7 warcallers, then 8 regenerators, and 8 bulwarks.
		[10] = { g("boss", 1, 0.00), g("bulwark", 4, 1.17, 0.73), g("runner", 4, 0.50, 1.03), g("warcaller", 7, 0.50, 0.82), g("regenerator", 8, 0.60, 0.95), g("bulwark", 8, 1.21, 1.04) },
		[11] = { g("bulwark", 3, 1.17), g("runner", 4, 0.50, 0.33), g("warcaller", 8, 0.50, 0.09), g("regenerator", 8, 0.60, 0.25), g("bulwark", 9, 1.24, 0.41) },
		[12] = { g("bulwark", 7, 1.17), g("runner", 8, 0.50, 0.32), g("warcaller", 11, 0.50, 0.16), g("regenerator", 15, 0.67, 0.39) },
		[13] = { g("bulwark", 4, 1.17), g("runner", 6, 0.50, 0.30), g("grunt", 9, 0.50, 0.08), g("tank", 10, 0.55, 0.19), g("runner", 11, 0.50, 0.33) },
		[14] = { g("bulwark", 3, 1.17), g("runner", 5, 0.50, 0.28), g("warcaller", 8, 0.50, 0.08), g("regenerator", 8, 0.60, 0.22), g("bulwark", 9, 1.24, 0.35) },
		[15] = { g("bulwark", 3, 1.17), g("runner", 4, 0.50, 0.32), g("warcaller", 8, 0.50, 0.08), g("regenerator", 9, 0.60, 0.16), g("bulwark", 9, 1.17, 0.29), g("runner", 10, 0.50, 0.39) },
		[16] = { g("bulwark", 7, 1.17), g("runner", 9, 0.50, 0.27), g("warcaller", 12, 0.50, 0.14), g("regenerator", 16, 0.67, 0.33) },
		[17] = { g("bulwark", 5, 1.17), g("runner", 6, 0.50, 0.27), g("grunt", 10, 0.50, 0.07), g("tank", 11, 0.55, 0.17), g("runner", 12, 0.50, 0.30) },
		[18] = { g("bulwark", 4, 1.17), g("runner", 5, 0.50, 0.26), g("warcaller", 9, 0.50, 0.07), g("regenerator", 9, 0.60, 0.20), g("bulwark", 10, 1.24, 0.31) },
		[19] = { g("bulwark", 4, 1.17), g("runner", 5, 0.50, 0.26), g("warcaller", 9, 0.50, 0.07), g("regenerator", 10, 0.60, 0.13), g("bulwark", 10, 1.17, 0.24), g("runner", 11, 0.50, 0.31) },
		[20] = { g("boss", 1, 0.00), g("bulwark", 5, 1.17, 0.66), g("runner", 5, 0.50, 0.93), g("warcaller", 9, 0.50, 0.74), g("regenerator", 10, 0.60, 0.85), g("bulwark", 10, 1.21, 0.94) },
	},
	steppingstones = {
		-- 20 grunts.
		[1] = { g("grunt", 20, 0.80) },
		...
		[5] = { g("warcaller", 11, 0.78), g("bulwark", 4, 1.53, 1.40), g("runner", 5, 0.56, 1.70) },
		-- 5 bulwarks, then 7 runners, then 10 warcallers, and 13 regenerators.
		[6] = { g("bulwark", 5, 1.31), g("runner", 7, 0.50, 0.30), g("warcaller", 10, 0.70, 1.00), g("regenerator", 13, 0.91, 2.00) },
		-- 3 bulwarks, then 4 runners, then 7 warcallers, then 7 regenerators, and 8 bulwarks.
		[7] = { g("bulwark", 3, 1.24), g("runner", 4, 0.50, 0.30), g("warcaller", 7, 0.61, 0.95), g("regenerator", 7, 0.80, 1.75), g("bulwark", 8, 1.67, 2.35) },
		-- 8 grunts, then 8 tanks, then 9 runners, and 10 bulwarks.
		[8] = { g("grunt", 8, 0.50), g("tank", 8, 0.59, 0.95), g("runner", 9, 0.61, 1.55), g("bulwark", 10, 1.49, 2.15) },
		-- 4 bulwarks, then 4 runners, then 8 warcallers, then 9 regenerators, then 9 bulwarks, and 10 runners.
		[9] = { g("bulwark", 4, 1.17), g("runner", 4, 0.50, 0.30), g("warcaller", 8, 0.51, 0.75), g("regenerator", 9, 0.68, 1.35), g("bulwark", 9, 1.42, 1.95), g("runner", 10, 0.72, 2.35) },
		-- 1 boss, then 4 bulwarks, then 4 runners, then 7 warcallers, then 8 regenerators, and 8 bulwarks.
		[10] = { g("boss", 1, 0.00), g("bulwark", 4, 1.17, 3.95), g("runner", 4, 0.50, 4.25), g("warcaller", 7, 0.58, 4.35), g("regenerator", 8, 0.76, 4.95), g("bulwark", 8, 1.60, 5.35) },
		[11] = { g("bulwark", 3, 1.24), g("runner", 4, 0.50, 0.33), g("warcaller", 8, 0.61, 1.04), g("regenerator", 8, 0.80, 1.93), g("bulwark", 9, 1.67, 2.59) },
		[12] = { g("bulwark", 6, 1.31), g("runner", 8, 0.50, 0.32), g("warcaller", 11, 0.70, 1.05), g("regenerator", 15, 0.91, 2.10) },
		[13] = { g("grunt", 9, 0.50), g("tank", 9, 0.59, 0.95), g("runner", 10, 0.61, 1.55), g("bulwark", 11, 1.49, 2.15) },
		[14] = { g("bulwark", 3, 1.24), g("runner", 5, 0.50, 0.28), g("warcaller", 8, 0.61, 0.90), g("regenerator", 8, 0.80, 1.66), g("bulwark", 9, 1.67, 2.23) },
		[15] = { g("bulwark", 4, 1.17), g("runner", 4, 0.50, 0.32), g("warcaller", 9, 0.51, 0.79), g("regenerator", 10, 0.68, 1.42), g("bulwark", 10, 1.42, 2.05), g("runner", 11, 0.72, 2.47) },
		[16] = { g("bulwark", 6, 1.31), g("runner", 9, 0.50, 0.27), g("warcaller", 12, 0.70, 0.90), g("regenerator", 16, 0.91, 1.80) },
		[17] = { g("grunt", 10, 0.50), g("tank", 10, 0.59, 0.85), g("runner", 11, 0.61, 1.40), g("bulwark", 12, 1.49, 1.94) },
		[18] = { g("bulwark", 4, 1.24), g("runner", 5, 0.50, 0.26), g("warcaller", 9, 0.61, 0.81), g("regenerator", 9, 0.80, 1.49), g("bulwark", 10, 1.67, 2.00) },
		[19] = { g("bulwark", 5, 1.17), g("runner", 5, 0.50, 0.26), g("warcaller", 10, 0.51, 0.64), g("regenerator", 11, 0.68, 1.15), g("bulwark", 11, 1.42, 1.66), g("runner", 13, 0.72, 2.00) },
		[20] = { g("boss", 1, 0.00), g("bulwark", 5, 1.17, 3.56), g("runner", 5, 0.50, 3.83), g("warcaller", 9, 0.58, 3.91), g("regenerator", 10, 0.76, 4.46), g("bulwark", 10, 1.60, 4.81) },
	},
	twinloop = {
		-- 20 grunts.
		[1] = { g("grunt", 20, 0.51) },
		...
		[5] = { g("summoner", 1, 0.00), g("warcaller", 10, 0.52, 0.52), g("bulwark", 4, 1.17, 0.43), g("runner", 4, 0.50, 0.73) },
		-- 6 bulwarks, then 7 runners, then 10 warcallers, and 13 regenerators.
		[6] = { g("bulwark", 6, 1.17), g("runner", 7, 0.50, 0.30), g("warcaller", 10, 0.50, 0.31), g("regenerator", 13, 0.64, 0.62) },
		-- 3 bulwarks, then 4 runners, then 7 warcallers, then 7 regenerators, and 8 bulwarks.
		[7] = { g("bulwark", 3, 1.17), g("runner", 4, 0.50, 0.30), g("warcaller", 7, 0.50, 0.19), g("regenerator", 7, 0.60, 0.43), g("bulwark", 8, 1.21, 0.62) },
		-- 1 summoner, then 7 tanks, then 7 runners, then 8 bulwarks, and 10 regenerators.
		[8] = { g("summoner", 1, 0.00), g("tank", 7, 0.55, 0.50), g("runner", 7, 0.50, 0.19), g("bulwark", 8, 1.17, 0.37), g("regenerator", 10, 0.60, 0.56) },
		-- 3 bulwarks, then 4 runners, then 7 warcallers, then 8 regenerators, then 8 bulwarks, and 9 runners.
		[9] = { g("bulwark", 3, 1.17), g("runner", 4, 0.50, 0.30), g("warcaller", 7, 0.50, 0.12), g("regenerator", 8, 0.60, 0.31), g("bulwark", 8, 1.17, 0.50), g("runner", 9, 0.50, 0.62) },
		-- 1 boss, then 4 bulwarks, then 4 runners, then 7 warcallers, then 8 regenerators, and 7 bulwarks.
		[10] = { g("boss", 1, 0.00), g("bulwark", 4, 1.17, 1.12), g("runner", 4, 0.50, 1.42), g("warcaller", 7, 0.50, 1.24), g("regenerator", 8, 0.60, 1.43), g("bulwark", 7, 1.17, 1.55) },
		[11] = { g("summoner", 1, 0.00), g("bulwark", 2, 1.17, 0.50), g("runner", 4, 0.50, 0.33), g("warcaller", 8, 0.50, 0.21), g("regenerator", 8, 0.60, 0.47), g("bulwark", 9, 1.21, 0.68) },
		[12] = { g("bulwark", 7, 1.17), g("runner", 8, 0.50, 0.32), g("warcaller", 11, 0.50, 0.33), g("regenerator", 15, 0.64, 0.65) },
		[13] = { g("tank", 9, 0.55), g("runner", 8, 0.50, 0.19), g("bulwark", 9, 1.17, 0.37), g("regenerator", 11, 0.60, 0.56) },
		[14] = { g("summoner", 1, 0.00), g("bulwark", 2, 1.17, 0.50), g("runner", 5, 0.50, 0.28), g("warcaller", 8, 0.50, 0.18), g("regenerator", 8, 0.60, 0.41), g("bulwark", 9, 1.21, 0.59) },
		[15] = { g("bulwark", 3, 1.17), g("runner", 4, 0.50, 0.32), g("warcaller", 8, 0.50, 0.13), g("regenerator", 9, 0.60, 0.33), g("bulwark", 9, 1.17, 0.53), g("runner", 10, 0.50, 0.65) },
		[16] = { g("bulwark", 7, 1.17), g("runner", 9, 0.50, 0.27), g("warcaller", 12, 0.50, 0.28), g("regenerator", 16, 0.64, 0.56) },
		[17] = { g("summoner", 1, 0.00), g("tank", 9, 0.55, 0.50), g("runner", 8, 0.50, 0.17), g("bulwark", 10, 1.17, 0.33), g("regenerator", 12, 0.60, 0.50) },
		[18] = { g("bulwark", 4, 1.17), g("runner", 5, 0.50, 0.26), g("warcaller", 9, 0.50, 0.16), g("regenerator", 9, 0.60, 0.37), g("bulwark", 10, 1.21, 0.53) },
		[19] = { g("summoner", 1, 0.00), g("bulwark", 3, 1.17, 0.50), g("runner", 5, 0.50, 0.26), g("warcaller", 9, 0.50, 0.10), g("regenerator", 10, 0.60, 0.26), g("bulwark", 10, 1.17, 0.42), g("runner", 11, 0.50, 0.53) },
		[20] = { g("boss", 1, 0.00), g("summoner", 1, 0.00, 1.01), g("bulwark", 4, 1.17, 0.50), g("runner", 5, 0.50, 1.28), g("warcaller", 9, 0.50, 1.12), g("regenerator", 10, 0.60, 1.29), g("bulwark", 9, 1.17, 1.40) },
	},

	frostgate = {
		[1] = { g("tank", 12, 0.77) },
		[2] = { g("bulwark", 7, 1.75), g("grunt", 8, 0.62, 1.80) },
		[3] = { g("tank", 9, 0.73), g("regenerator", 6, 0.88, 1.55) },
		[4] = { g("bulwark", 8, 1.57), g("runner", 10, 0.55, 1.30) },
		[5] = { g("warcaller", 6, 0.76), g("tank", 12, 0.67, 1.60) },
		[6] = { g("regenerator", 8, 0.80), g("bulwark", 9, 1.46, 1.40), g("grunt", 10, 0.55, 1.05) },
		[7] = { g("tank", 10, 0.69), g("runner", 12, 0.50, 1.20), g("warcaller", 6, 0.72, 1.35) },
		[8] = { g("bulwark", 9, 1.49), g("regenerator", 9, 0.76, 1.25), g("tank", 11, 0.63, 1.10) },
		[9] = { g("warcaller", 7, 0.68), g("bulwark", 10, 1.39, 1.15), g("runner", 13, 0.50, 1.00) },
		[10] = { g("boss", 1, 0.00), g("tank", 11, 0.67, 2.40), g("regenerator", 9, 0.78, 1.65), g("bulwark", 9, 1.42, 1.45) },
		[11] = { g("tank", 12, 0.65), g("runner", 14, 0.50, 1.05), g("warcaller", 7, 0.66, 1.20) },
		[12] = { g("bulwark", 10, 1.42), g("regenerator", 10, 0.72, 1.15), g("grunt", 15, 0.50, 0.95) },
		[13] = { g("warcaller", 8, 0.64), g("tank", 13, 0.63, 1.05), g("runner", 15, 0.50, 0.90) },
		[14] = { g("regenerator", 11, 0.70), g("bulwark", 11, 1.35, 1.00), g("tank", 13, 0.61, 0.85) },
		[15] = { g("summoner", 2, 1.80), g("tank", 14, 0.61, 1.30), g("warcaller", 8, 0.62, 0.95) },
		[16] = { g("bulwark", 12, 1.31), g("runner", 17, 0.50, 0.80), g("regenerator", 11, 0.68, 0.90) },
		[17] = { g("tank", 15, 0.59), g("warcaller", 9, 0.60, 0.85), g("grunt", 18, 0.50, 0.70) },
		[18] = { g("regenerator", 12, 0.66), g("bulwark", 13, 1.28, 0.80), g("runner", 18, 0.50, 0.68) },
		[19] = { g("summoner", 2, 1.62), g("warcaller", 10, 0.58, 0.80), g("tank", 16, 0.57, 0.66), g("bulwark", 12, 1.24, 0.62) },
		[20] = { g("boss", 1, 0.00), g("bulwark", 13, 1.24, 2.10), g("regenerator", 12, 0.66, 1.15), g("tank", 16, 0.57, 0.90), g("runner", 18, 0.50, 0.72) },
	},
	tidelock = {
		[1] = { g("runner", 14, 0.58) },
		[2] = { g("warcaller", 5, 0.80), g("grunt", 10, 0.55, 0.65) },
		[3] = { g("regenerator", 6, 0.84), g("runner", 11, 0.52, 0.55) },
		[4] = { g("summoner", 2, 1.62), g("tank", 10, 0.63, 0.70) },
		[5] = { g("warcaller", 6, 0.70), g("bulwark", 8, 1.39, 0.50), g("runner", 12, 0.50, 0.45) },
		[6] = { g("regenerator", 8, 0.74), g("grunt", 13, 0.50, 0.42), g("tank", 9, 0.61, 0.50) },
		[7] = { g("summoner", 2, 1.51), g("runner", 14, 0.50, 0.52), g("bulwark", 8, 1.31, 0.44) },
		[8] = { g("warcaller", 7, 0.64), g("tank", 11, 0.59, 0.40), g("regenerator", 9, 0.70, 0.46) },
		[9] = { g("runner", 15, 0.50), g("summoner", 2, 1.44, 0.38), g("bulwark", 10, 1.28, 0.42) },
		[10] = { g("boss", 1, 0.00), g("warcaller", 8, 0.62, 1.30), g("runner", 15, 0.50, 0.66), g("regenerator", 9, 0.68, 0.58) },
		[11] = { g("summoner", 2, 1.40), g("tank", 12, 0.57, 0.38), g("runner", 16, 0.50, 0.36) },
		[12] = { g("regenerator", 10, 0.68), g("bulwark", 11, 1.24, 0.35), g("grunt", 16, 0.50, 0.34) },
		[13] = { g("warcaller", 9, 0.60), g("runner", 17, 0.50, 0.32), g("tank", 13, 0.57, 0.38) },
		[14] = { g("summoner", 3, 1.37), g("bulwark", 12, 1.21, 0.36), g("regenerator", 11, 0.66, 0.34) },
		[15] = { g("runner", 18, 0.50), g("warcaller", 10, 0.58, 0.30), g("tank", 14, 0.55, 0.32) },
		[16] = { g("regenerator", 12, 0.64), g("summoner", 3, 1.30, 0.32), g("bulwark", 13, 1.17, 0.30) },
		[17] = { g("warcaller", 11, 0.56), g("runner", 19, 0.50, 0.28), g("grunt", 18, 0.50, 0.26) },
		[18] = { g("summoner", 3, 1.22), g("tank", 15, 0.55, 0.28), g("regenerator", 13, 0.62, 0.26) },
		[19] = { g("runner", 20, 0.50), g("warcaller", 12, 0.54, 0.25), g("bulwark", 14, 1.17, 0.24), g("summoner", 3, 1.15, 0.24) },
		[20] = { g("boss", 1, 0.00), g("summoner", 3, 1.12, 1.10), g("runner", 20, 0.50, 0.52), g("warcaller", 12, 0.52, 0.46), g("bulwark", 14, 1.17, 0.42) },
	},
	ashspiral = {
		[1] = { g("grunt", 18, 0.52), g("runner", 8, 0.50, 0.30) },
		[2] = { g("tank", 10, 0.61), g("bulwark", 7, 1.31, 0.28) },
		[3] = { g("warcaller", 6, 0.62), g("regenerator", 7, 0.68, 0.26), g("runner", 10, 0.50, 0.24) },
		[4] = { g("summoner", 2, 1.37), g("grunt", 14, 0.50, 0.24), g("tank", 10, 0.57, 0.22) },
		[5] = { g("bulwark", 9, 1.24), g("runner", 13, 0.50, 0.22), g("warcaller", 7, 0.58, 0.20) },
		[6] = { g("regenerator", 9, 0.64), g("tank", 12, 0.55, 0.20), g("summoner", 2, 1.26, 0.20) },
		[7] = { g("runner", 15, 0.50), g("bulwark", 10, 1.21, 0.18), g("warcaller", 8, 0.56, 0.18) },
		[8] = { g("summoner", 3, 1.22), g("regenerator", 10, 0.62, 0.18), g("grunt", 17, 0.50, 0.16) },
		[9] = { g("tank", 13, 0.55), g("runner", 17, 0.50, 0.16), g("warcaller", 9, 0.54, 0.16) },
		[10] = { g("boss", 1, 0.00), g("summoner", 3, 1.15, 0.90), g("bulwark", 11, 1.17, 0.38), g("runner", 17, 0.50, 0.34), g("regenerator", 10, 0.60, 0.30) },
		[11] = { g("warcaller", 10, 0.52), g("tank", 14, 0.55, 0.15), g("runner", 18, 0.50, 0.15) },
		[12] = { g("summoner", 3, 1.12), g("regenerator", 11, 0.60, 0.15), g("bulwark", 12, 1.17, 0.14) },
		[13] = { g("runner", 19, 0.50), g("grunt", 20, 0.50, 0.14), g("warcaller", 11, 0.50, 0.14) },
		[14] = { g("tank", 15, 0.55), g("summoner", 4, 1.08, 0.14), g("regenerator", 12, 0.60, 0.13) },
		[15] = { g("bulwark", 13, 1.17), g("runner", 20, 0.50, 0.13), g("warcaller", 12, 0.50, 0.13) },
		[16] = { g("summoner", 4, 1.04), g("tank", 16, 0.55, 0.12), g("regenerator", 13, 0.60, 0.12) },
		[17] = { g("runner", 21, 0.50), g("bulwark", 14, 1.17, 0.12), g("warcaller", 13, 0.50, 0.11) },
		[18] = { g("regenerator", 14, 0.60), g("summoner", 4, 1.01, 0.11), g("tank", 17, 0.55, 0.11) },
		[19] = { g("warcaller", 14, 0.50), g("runner", 22, 0.50, 0.10), g("bulwark", 15, 1.17, 0.10), g("summoner", 4, 0.97, 0.10) },
		[20] = { g("boss", 1, 0.00), g("summoner", 4, 0.94, 0.72), g("warcaller", 14, 0.50, 0.28), g("regenerator", 14, 0.60, 0.25), g("bulwark", 15, 1.17, 0.22), g("runner", 22, 0.50, 0.20) },
	},
}
