...
local wavesByMapId = {
	...
	snaketrail = {
		...
		[2] = { g("grunt", 12, 0.52) },
		[3] = { g("runner", 12, 0.58) },
		[4] = { g("grunt", 12, 0.50), g("runner", 10, 0.52, 1.50) },
		[5] = { g("runner", 14, 0.52), g("grunt", 12, 0.50, 1.40) },
		[6] = { g("grunt", 15, 0.50), g("grunt", 14, 0.55, 1.20) },
		[7] = { g("runner", 16, 0.50), g("grunt", 12, 0.50, 1.12) },
		[8] = { g("grunt", 15, 0.50), g("runner", 15, 0.50, 0.90) },
		[9] = { g("runner", 17, 0.50), g("grunt", 15, 0.50, 0.95) },
		[10] = { g("boss", 1, 0.00), g("grunt", 15, 0.50, 1.51), g("runner", 16, 0.50, 1.20) },
		[11] = { g("runner", 18, 0.50), g("grunt", 15, 0.50, 0.90) },
		[12] = { g("grunt", 15, 0.50), g("grunt", 18, 0.52, 0.80) },
		[13] = { g("runner", 19, 0.50), g("grunt", 15, 0.50, 0.84) },
		[14] = { g("grunt", 18, 0.50), g("runner", 18, 0.50, 0.70) },
		[15] = { g("runner", 20, 0.50), g("grunt", 15, 0.50, 0.76) },
		[16] = { g("grunt", 18, 0.50), g("grunt", 20, 0.50, 0.65) },
		[17] = { g("runner", 21, 0.50), g("grunt", 18, 0.50, 0.69) },
		[18] = { g("grunt", 21, 0.50), g("runner", 20, 0.50, 0.60) },
		[19] = { g("runner", 22, 0.50), g("grunt", 18, 0.50, 0.65) },
		[20] = { g("boss", 1, 0.00), g("grunt", 21, 0.50, 1.34), g("runner", 21, 0.50, 1.05) },
	},
	backtrack = {
		-- 17 grunts.
		[1] = { g("grunt", 17, 0.70) },
		...
		-- 11 grunts followed by 8 runners.
		[5] = { g("grunt", 21, 0.50), g("runner", 8, 0.53, 0.52) },
		-- 10 runners, then 10 grunts, and 14 grunts.
		[6] = { g("runner", 10, 0.50), g("grunt", 18, 0.50, 0.43), g("grunt", 14, 0.63, 0.75) },
		-- 6 runners, then 8 grunts, and 8 grunts.
		[7] = { g("runner", 6, 0.50), g("grunt", 15, 0.50, 0.25), g("grunt", 8, 0.53, 0.52) },
		-- 8 grunts, then 8 runners, and 10 grunts.
		[8] = { g("grunt", 15, 0.50), g("runner", 8, 0.50, 0.22), g("grunt", 10, 0.50, 0.45) },
		-- 7 runners, then 8 grunts, and 10 grunts.
		[9] = { g("runner", 7, 0.50), g("grunt", 15, 0.50, 0.17), g("grunt", 10, 0.50, 0.38) },
		-- 1 boss, then 7 runners, then 7 grunts, and 8 grunts.
		[10] = { g("boss", 1, 0.00), g("runner", 7, 0.50, 1.35), g("grunt", 12, 0.50, 1.68), g("grunt", 8, 0.50, 1.72) },
		[11] = { g("runner", 6, 0.50), g("grunt", 15, 0.50, 0.27), g("grunt", 9, 0.53, 0.57) },
		[12] = { g("runner", 11, 0.50), g("grunt", 21, 0.50, 0.45), g("grunt", 16, 0.63, 0.79) },
		[13] = { g("grunt", 15, 0.50), g("runner", 9, 0.50, 0.22), g("grunt", 11, 0.50, 0.45) },
		[14] = { g("runner", 7, 0.50), g("grunt", 15, 0.50, 0.24), g("grunt", 9, 0.53, 0.49) },
		[15] = { g("runner", 8, 0.50), g("grunt", 15, 0.50, 0.18), g("grunt", 11, 0.50, 0.40) },
		[16] = { g("runner", 12, 0.50), g("grunt", 21, 0.50, 0.38), g("grunt", 17, 0.63, 0.68) },
		[17] = { g("grunt", 18, 0.50), g("runner", 10, 0.50, 0.20), g("grunt", 12, 0.50, 0.41) },
		[18] = { g("runner", 8, 0.50), g("grunt", 18, 0.50, 0.21), g("grunt", 10, 0.53, 0.44) },
		[19] = { g("runner", 9, 0.50), g("grunt", 18, 0.50, 0.15), g("grunt", 13, 0.50, 0.32) },
		[20] = { g("boss", 1, 0.00), g("runner", 9, 0.50, 1.22), g("grunt", 15, 0.50, 1.51), g("grunt", 10, 0.50, 1.55) },
	},
	lowvalley = {
		-- 17 grunts.
		[1] = { g("grunt", 17, 0.82) },
		-- 9 grunts.
		[2] = { g("grunt", 27, 0.59) },
		-- 13 grunts followed by 4 grunts.
		[3] = { g("grunt", 13, 0.69), g("grunt", 12, 0.58, 2.17) },
		-- 10 grunts followed by 13 grunts.
		[4] = { g("grunt", 30, 0.50), g("grunt", 13, 0.57, 1.16) },
		-- 10 runners followed by 8 grunts.
		[5] = { g("runner", 10, 0.71), g("grunt", 24, 0.50, 1.01) },
		-- 10 grunts, then 9 runners, and 13 grunts.
		[6] = { g("grunt", 30, 0.50), g("runner", 9, 0.63, 0.72), g("grunt", 24, 0.50, 1.62) },
		-- 6 grunts, then 7 runners, then 7 grunts, and 9 grunts.
		[7] = { g("grunt", 18, 0.50), g("runner", 7, 0.56, 0.43), g("grunt", 12, 0.50, 1.13), g("grunt", 9, 0.71, 1.45) },
		-- 8 grunts, then 8 grunts, then 9 runners, and 11 grunts.
		[8] = { g("grunt", 8, 0.50), g("grunt", 15, 0.50, 0.48), g("runner", 9, 0.56, 0.87), g("grunt", 33, 0.50, 1.30) },
		-- 7 grunts, then 8 runners, then 9 grunts, and 9 grunts.
		[9] = { g("grunt", 21, 0.50), g("runner", 8, 0.50, 0.29), g("grunt", 15, 0.50, 0.81), g("grunt", 9, 0.59, 1.16) },
		-- 1 boss, then 7 grunts, then 7 runners, then 8 grunts, and 8 grunts.
		[10] = { g("boss", 1, 0.00), g("grunt", 21, 0.50, 2.61), g("runner", 7, 0.52, 2.90), g("grunt", 15, 0.50, 3.73), g("grunt", 8, 0.67, 3.62) },
		[11] = { g("grunt", 18, 0.50), g("runner", 8, 0.56, 0.47), g("grunt", 15, 0.50, 1.24), g("grunt", 10, 0.71, 1.59) },
		[12] = { g("grunt", 33, 0.50), g("runner", 10, 0.63, 0.76), g("grunt", 27, 0.50, 1.70) },
		[13] = { g("grunt", 9, 0.50), g("grunt", 15, 0.50, 0.48), g("runner", 10, 0.56, 0.87), g("grunt", 36, 0.50, 1.30) },
		[14] = { g("grunt", 21, 0.50), g("runner", 8, 0.56, 0.41), g("grunt", 15, 0.50, 1.08), g("grunt", 10, 0.71, 1.38) },
		[15] = { g("grunt", 24, 0.50), g("runner", 9, 0.50, 0.30), g("grunt", 18, 0.50, 0.85), g("grunt", 10, 0.59, 1.22) },
		[16] = { g("grunt", 36, 0.50), g("runner", 11, 0.63, 0.65), g("grunt", 27, 0.50, 1.46) },
		[17] = { g("grunt", 10, 0.50), g("grunt", 18, 0.50, 0.44), g("runner", 11, 0.56, 0.78), g("grunt", 39, 0.50, 1.17) },
		[18] = { g("grunt", 24, 0.50), g("runner", 9, 0.56, 0.37), g("grunt", 15, 0.50, 0.96), g("grunt", 12, 0.71, 1.23) },
		[19] = { g("grunt", 27, 0.50), g("runner", 10, 0.50, 0.25), g("grunt", 21, 0.50, 0.68), g("grunt", 11, 0.59, 0.99) },
		[20] = { g("boss", 1, 0.00), g("grunt", 27, 0.50, 2.35), g("runner", 9, 0.52, 2.61), g("grunt", 18, 0.50, 3.36), g("grunt", 10, 0.67, 3.26) },
	},
	circuit = {
		-- 17 grunts.
		[1] = { g("grunt", 17, 0.70) },
		...
		-- 10 grunts followed by 7 regenerators.
		[5] = { g("grunt", 30, 0.50), g("regenerator", 7, 0.66, 0.45) },
		-- 10 regenerators, then 9 grunts, and 13 runners.
		[6] = { g("regenerator", 10, 0.60), g("grunt", 27, 0.50, 0.33), g("runner", 13, 0.65, 0.65) },
		-- 6 regenerators, then 7 grunts, then 7 runners, and 8 grunts.
		[7] = { g("regenerator", 6, 0.60), g("grunt", 21, 0.50, 0.20), g("runner", 7, 0.56, 0.45), g("grunt", 15, 0.50, 0.73) },
		-- 8 regenerators, then 8 grunts, then 9 grunts, and 10 runners.
		[8] = { g("regenerator", 8, 0.60), g("grunt", 8, 0.50, 0.20), g("grunt", 15, 0.50, 0.44), g("runner", 10, 0.55, 0.59) },
		-- 6 regenerators, then 7 grunts, then 9 runners, then 9 grunts, and 10 grunts.
		[9] = { g("regenerator", 6, 0.60), g("grunt", 21, 0.50, 0.13), g("runner", 9, 0.50, 0.33), g("grunt", 15, 0.50, 0.58), g("grunt", 10, 0.57, 0.65) },
		-- 1 boss, then 6 regenerators, then 7 grunts, then 8 runners, and 8 grunts.
		[10] = { g("boss", 1, 0.00), g("regenerator", 6, 0.60, 1.17), g("grunt", 21, 0.50, 1.30), g("runner", 8, 0.53, 1.49), g("grunt", 15, 0.50, 1.81) },
		[11] = { g("regenerator", 6, 0.60), g("grunt", 24, 0.50, 0.22), g("runner", 8, 0.56, 0.50), g("grunt", 15, 0.50, 0.81) },
		[12] = { g("regenerator", 11, 0.60), g("grunt", 30, 0.50, 0.35), g("runner", 15, 0.65, 0.68) },
		[13] = { g("regenerator", 9, 0.60), g("grunt", 9, 0.50, 0.20), g("grunt", 18, 0.50, 0.44), g("runner", 11, 0.55, 0.59) },
		[14] = { g("regenerator", 7, 0.60), g("grunt", 24, 0.50, 0.19), g("runner", 8, 0.56, 0.43), g("grunt", 15, 0.50, 0.69) },
		[15] = { g("regenerator", 7, 0.60), g("grunt", 24, 0.50, 0.14), g("runner", 10, 0.50, 0.35), g("grunt", 18, 0.50, 0.62), g("grunt", 11, 0.57, 0.68) },
		[16] = { g("regenerator", 12, 0.60), g("grunt", 33, 0.50, 0.30), g("runner", 16, 0.65, 0.59) },
		[17] = { g("regenerator", 10, 0.60), g("grunt", 10, 0.50, 0.18), g("grunt", 21, 0.50, 0.39), g("runner", 12, 0.55, 0.53) },
		[18] = { g("regenerator", 8, 0.60), g("grunt", 27, 0.50, 0.17), g("runner", 9, 0.56, 0.38), g("grunt", 18, 0.50, 0.62) },
		[19] = { g("regenerator", 8, 0.60), g("grunt", 27, 0.50, 0.11), g("runner", 11, 0.50, 0.28), g("grunt", 21, 0.50, 0.49), g("grunt", 13, 0.57, 0.55) },
		[20] = { g("boss", 1, 0.00), g("regenerator", 8, 0.60, 1.05), g("grunt", 27, 0.50, 1.17), g("runner", 10, 0.53, 1.34), g("grunt", 18, 0.50, 1.64) },
	},
	outerloop = {
		-- Regenerators arrive in small escorted pockets, with a late Grunt preview.
		[1] = { g("grunt", 14, 0.82) },
		[2] = { g("grunt", 8, 0.58), g("regenerator", 2, 1.00, 1.40) },
		[3] = { g("grunt", 12, 0.55), g("regenerator", 3, 0.95, 1.10) },
		[4] = { g("grunt", 9, 0.50), g("grunt", 12, 0.52, 1.40) },
		...
		[8] = { g("grunt", 12, 0.50), g("runner", 12, 0.50, 1.10) },
		...
		[11] = { g("grunt", 12, 0.50), g("grunt", 16, 0.50, 1.00) },
		[12] = { g("grunt", 16, 0.50), g("regenerator", 5, 0.84, 0.70) },
		[13] = { g("runner", 16, 0.50), g("grunt", 12, 0.50, 0.95) },
		[14] = { g("grunt", 12, 0.50), g("regenerator", 5, 0.82, 0.65), g("grunt", 10, 0.50, 0.85) },
		[15] = { g("grunt", 6, 0.66), g("grunt", 18, 0.50, 1.60) },
		[16] = { g("grunt", 16, 0.50), g("regenerator", 5, 0.80, 0.60), g("runner", 10, 0.50, 0.80) },
		[17] = { g("grunt", 9, 0.63), g("runner", 16, 0.50, 1.40) },
		[18] = { g("grunt", 15, 0.50), g("grunt", 18, 0.50, 0.75) },
		[19] = { g("grunt", 14, 0.50), g("regenerator", 6, 0.78, 0.55), g("runner", 10, 0.50, 0.75) },
		[20] = { g("boss", 1, 0.00), g("grunt", 9, 0.60, 1.20), g("grunt", 18, 0.50, 1.30) },
	},
	terrace = {
		-- 17 grunts.
		[1] = { g("grunt", 17, 0.61) },
	...
	highridge = {
		-- 17 grunts.
		[1] = { g("grunt", 17, 0.78) },
		-- 6 grunts followed by 6 runners.
		[2] = { g("grunt", 18, 0.61), g("runner", 6, 0.70, 0.30) },
		-- 13 grunts, then 2 grunts, and 2 runners.
	...
	crossflow = {
		...
		[1] = { g("grunt", 19, 0.56) },
		-- 6 grunts followed by 6 runners.
		[2] = { g("grunt", 18, 0.50), g("runner", 6, 0.51, 0.30) },
		-- 14 grunts, then 2 grunts, and 2 runners.
	...
	steppingstones = {
		...
		[1] = { g("grunt", 20, 0.80) },
		-- 6 grunts followed by 6 runners.
		[2] = { g("grunt", 18, 0.64), g("runner", 6, 0.74, 0.30) },
		-- 14 grunts, then 2 grunts, and 2 runners.
