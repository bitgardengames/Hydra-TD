...
local AbilityDefs = {
	...
	gold_rush = {id="gold_rush", nameKey="ability.goldRush.name", descKey="ability.goldRush.desc", utilityRole="economy", cooldown=55, targeting="instant", effect={kind="income_multiplier",duration=8,multiplier=2.0}, upgradeId="enhanced_abilities", upgradedEffect={kind="income_multiplier",duration=12,multiplier=2.0,bossMultiplier=3.0}},
