...
Backdrop.shots = {
...

	{
		...
		map = 3,
		towers = {
			{kind = "slow", gx = 13, gy = 7, level = 2},
			{kind = "lancer", gx = 14, gy = 7, level = 3},
			{kind = "poison", gx = 13, gy = 8, level = 4},
			{kind = "cannon", gx = 11, gy = 6, level = 3},
			{kind = "poison", gx = 20, gy = 7, level = 3},
			{kind = "plasma", gx = 21, gy = 4, level = 3},
			{kind = "shock", gx = 11, gy = 4, level = 3},
