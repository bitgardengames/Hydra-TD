...
RunModes.setExperimentalModules(state, true)
assert(RunModes.experimentalModulesEnabled(state), "module experiments should be explicitly opt-in")
...
RunModes.setExperimentalModules(state, false)
RunModes.set(state, RunModes.ENDLESS)
