...
Biomes.defs = {
	...
	autumn = {
		terrain = {
			grass = {0.38, 0.50, 0.24},
			path = {0.76, 0.62, 0.40},
			pathOutline = {0.46, 0.29, 0.16},
			water = {0.24, 0.52, 0.58},
		},
		...
		world = {
			tree = {
				trunk = {0.43, 0.25, 0.14},
				trunkOutline = {0.23, 0.12, 0.07},

				shapes = {"evergreen", "round"},

				styles = {
					{fill = {0.82, 0.18, 0.10}, outline = {0.46, 0.08, 0.05}},
					{fill = {0.95, 0.39, 0.10}, outline = {0.58, 0.19, 0.05}},
					{fill = {0.98, 0.68, 0.12}, outline = {0.65, 0.39, 0.05}},
					{fill = {0.66, 0.20, 0.24}, outline = {0.36, 0.08, 0.12}},
				}
			},
			...
			rock = {
				styles = {
					...
					{fill = {0.72, 0.61, 0.48}, outline = {0.40, 0.31, 0.24}},
					{fill = {0.59, 0.53, 0.48}, outline = {0.33, 0.28, 0.25}},
				},
			},
		},
