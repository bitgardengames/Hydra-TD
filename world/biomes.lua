...
Biomes.defs = {
	...
	autumn = {
		terrain = {
			grass = {0.34, 0.39, 0.24},
			path = {0.60, 0.50, 0.38},
			pathOutline = {0.34, 0.28, 0.22},
			water = {0.28, 0.40, 0.41},
		},
		...
		world = {
			tree = {
				trunk = {0.36, 0.25, 0.17},
				trunkOutline = {0.22, 0.15, 0.10},

				shapes = {"evergreen", "round"},

				styles = {
					{fill = {0.58, 0.28, 0.16}, outline = {0.34, 0.17, 0.10}},
					{fill = {0.68, 0.39, 0.20}, outline = {0.40, 0.23, 0.12}},
					{fill = {0.72, 0.53, 0.25}, outline = {0.43, 0.31, 0.14}},
					{fill = {0.48, 0.25, 0.20}, outline = {0.29, 0.15, 0.12}},
				}
			},
			...
			rock = {
				styles = {
					...
					{fill = {0.57, 0.51, 0.44}, outline = {0.34, 0.29, 0.24}},
					{fill = {0.50, 0.46, 0.41}, outline = {0.30, 0.27, 0.23}},
				},
			},
		},
