...
Biomes.defs = {
	...
	autumn = {
		terrain = {
			grass = {0.34, 0.40, 0.23},
			path = {0.61, 0.50, 0.37},
			pathOutline = {0.35, 0.28, 0.21},
			water = {0.27, 0.41, 0.42},
		},
		...
		world = {
			tree = {
				trunk = {0.37, 0.25, 0.16},
				trunkOutline = {0.23, 0.15, 0.09},

				shapes = {"evergreen", "round"},

				styles = {
					{fill = {0.61, 0.27, 0.13}, outline = {0.35, 0.16, 0.09}},
					{fill = {0.71, 0.38, 0.17}, outline = {0.42, 0.23, 0.10}},
					{fill = {0.75, 0.54, 0.22}, outline = {0.45, 0.31, 0.12}},
					{fill = {0.50, 0.24, 0.18}, outline = {0.30, 0.14, 0.11}},
				}
			},
			...
			rock = {
				styles = {
					...
					{fill = {0.58, 0.51, 0.43}, outline = {0.35, 0.29, 0.23}},
					{fill = {0.51, 0.46, 0.40}, outline = {0.31, 0.27, 0.22}},
				},
			},
		},
