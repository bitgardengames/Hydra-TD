...
Biomes.defs = {
	...
	autumn = {
		terrain = {
			grass = {0.40, 0.43, 0.22},
			path = {0.72, 0.54, 0.32},
			pathOutline = {0.39, 0.24, 0.14},
			water = {0.27, 0.43, 0.43},
		},
		...
		world = {
			tree = {
				trunk = {0.40, 0.23, 0.13},
				trunkOutline = {0.22, 0.12, 0.07},

				shapes = {"evergreen", "round"},

				styles = {
					{fill = {0.68, 0.22, 0.10}, outline = {0.38, 0.11, 0.06}},
					{fill = {0.86, 0.38, 0.12}, outline = {0.50, 0.20, 0.07}},
					{fill = {0.91, 0.61, 0.18}, outline = {0.57, 0.35, 0.09}},
					{fill = {0.56, 0.19, 0.16}, outline = {0.31, 0.09, 0.08}},
				}
			},
			...
			rock = {
				styles = {
					...
					{fill = {0.64, 0.54, 0.43}, outline = {0.36, 0.28, 0.22}},
					{fill = {0.55, 0.48, 0.42}, outline = {0.30, 0.25, 0.22}},
				},
			},
		},
