...
Biomes.defs = {
	...
	highlands = { -- Cool, windswept uplands
		...
		world = {
			tree = {
				trunk = {0.31, 0.22, 0.16},
				trunkOutline = {0.16, 0.12, 0.09},
				shapes = {"evergreen", "square"},

				styles = {
					{fill = {0.13, 0.37, 0.27}, outline = {0.05, 0.22, 0.16}},
					{fill = {0.10, 0.31, 0.25}, outline = {0.04, 0.18, 0.14}},
					{fill = {0.18, 0.43, 0.30}, outline = {0.07, 0.26, 0.17}},
					{fill = {0.11, 0.35, 0.38}, outline = {0.04, 0.20, 0.22}},
				},
			},
