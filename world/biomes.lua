...
Biomes.defs = {
	...
	highlands = { -- Cool, windswept uplands
		...
		world = {
			tree = {
				...
				styles = {
					{fill = {0.34, 0.64, 0.32}, outline = {0.12, 0.34, 0.14}},
					{fill = {0.26, 0.57, 0.27}, outline = {0.09, 0.29, 0.12}},
					{fill = {0.45, 0.70, 0.34}, outline = {0.18, 0.39, 0.15}},
					{fill = {0.38, 0.63, 0.24}, outline = {0.14, 0.34, 0.10}},
				},
			},
	...
	autumn = {
		terrain = {
			grass = {0.34, 0.41, 0.22},
			path = {0.62, 0.50, 0.36},
			pathOutline = {0.36, 0.28, 0.20},
			water = {0.26, 0.42, 0.43},
		},
		...
		world = {
			tree = {
				trunk = {0.38, 0.25, 0.15},
				trunkOutline = {0.24, 0.15, 0.08},

				shapes = {"evergreen", "round"},

				styles = {
					{fill = {0.63, 0.26, 0.11}, outline = {0.36, 0.15, 0.08}},
					{fill = {0.73, 0.37, 0.15}, outline = {0.44, 0.22, 0.09}},
					{fill = {0.77, 0.54, 0.20}, outline = {0.47, 0.31, 0.11}},
					{fill = {0.52, 0.23, 0.17}, outline = {0.31, 0.13, 0.10}},
				}
			},
			...
			rock = {
				styles = {
					...
					{fill = {0.59, 0.51, 0.42}, outline = {0.36, 0.29, 0.22}},
					{fill = {0.52, 0.46, 0.39}, outline = {0.32, 0.27, 0.21}},
				},
			},
		},
