return {
	...
	moduleDesc = {
		...
		slow_frost_aura = "Hits apply lighter slow and lower direct damage, but emits a high-uptime chill aura around the tower.",
		...
		slow_glacial_barrage = "Hits deal lower direct damage, but striking already-slowed enemies occasionally triggers a burst cleave of frost shards.",
		...
		lancer_focus_fire = "Repeated hits on the same target gain +18% damage per stack.",
