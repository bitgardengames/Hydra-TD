return {
	...
	moduleDesc = {
		...
		poison_cull_weak = "Prioritizes low-health enemies and increases poison stack capacity.",
		poison_corrupt_strong = "Prioritizes high-health enemies and strengthens poison damage.",
