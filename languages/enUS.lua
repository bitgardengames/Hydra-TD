return {
	...
	moduleDesc = {
		...
		cannon_long_fuse = "Shells travel on a short fuse before a heavy detonation with a wider blast radius.",
		cannon_frontline_burst = "Shells fracture on impact into close-range follow-up blasts for stronger concentrated damage.",
