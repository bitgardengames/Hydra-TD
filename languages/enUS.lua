return {
	...
	moduleDesc = {
		...
		slow_glacier_core = "Hits apply a stronger, longer slow.",
		slow_permafrost = "Applies a lighter slow and splinters into follow-up frost shots.",
		slow_frost_nova = "Deals bonus damage to slowed enemies.",
		slow_shatterburst = "Piercing shots gain damage per enemy hit.",
		slow_cold_snap = "Targets enemies furthest along the path.",
		slow_black_ice = "Targets dense groups and splinters on hit.",
		slow_frost_shards = "Applies a lighter slow and splinters into follow-up frost shots.",
		slow_shatter = "Deals bonus damage to slowed enemies.",
		slow_snowball = "Piercing shots gain damage per enemy hit.",
		slow_lead_freeze = "Targets enemies furthest along the path.",
		slow_wide_chill = "Targets dense groups and splinters on hit.",
		slow_absolute_zero = "Applies a brief near-freeze slow.",
		slow_hailstorm = "Hits split into extra frost shots.",
		lancer_deadeye = "Targets low-HP enemies first.",
		lancer_volley = "Shots split into two projectiles on impact.",
		lancer_ricochet = "Shots bounce to a nearby enemy after impact.",
		lancer_rail_lance = "Converts shots into infinite-pierce lances.",
		...
		poison_hemotoxin = "Poison ticks scale with missing enemy HP.",
		poison_pandemic = "Poison spread can chain through deaths.",
		cannon_siege_shells = "Fires shells with larger blast radius.",
		cannon_rapid_mortar = "Smaller blasts and damage, faster barrage.",
		cannon_cluster_payload = "Explosions spawn mini-shells that keep traveling.",
		cannon_shockwave = "Shells trade control for heavier explosion damage.",
		cannon_long_fuse = "Targets enemies farthest from the tower.",
		cannon_frontline_burst = "Targets enemies furthest along the path.",
		cannon_mega_shell = "Massive shells with huge radius and damage.",
		cannon_carpet_fire = "Each shot adds two staggered follow-up shells.",
		...
		shock_overload = "Fewer chain jumps, higher single-target damage.",
		shock_storm_coil = "Adds chain jumps for wider coverage.",
		shock_overcharge = "Fewer chains, heavier per-target shock damage.",
		shock_forked_arc = "Each chain link forks to two nearby enemies.",
		shock_static_surge = "Repeated shocks on a target ramp bonus damage.",
		shock_crowd_search = "Targets dense packs before chaining.",
		shock_boss_focus = "Targets healthiest enemies first.",
		shock_thunderstorm = "Greatly increases chain jumps.",
		shock_meltdown = "Chain endpoints detonate.",
		plasma_focused_core = "Fires a narrow plasma bolt with faster ticks.",
		plasma_unstable_core = "Fires a wider plasma mass with lower DPS.",
		plasma_boomerang_shot = "Plasma travels out, then returns.",
		plasma_spiral_drive = "Plasma follows a spiral path.",
		plasma_thermal_tracking = "Targets healthiest enemies in range.",
		plasma_lane_sweep = "Targets enemies furthest along the path.",
		plasma_supernova = "Projectile detonates at end of life.",
		plasma_growing_mass = "Projectile grows and gains damage over time.",
