return {
	...
	settings = {
		...
		screenShakeIntensityDesc = "Controls impact shake strength; set to zero for no shake.",
		...
		uiScale = "UI scale",
		uiScaleDesc = "Changes text size and reflows interface content.",
		msaaQuality = "Edge smoothing",
		msaaQualityDesc = "Higher MSAA reduces jagged edges but increases GPU and video-memory use.",
		msaaAuto = "Auto",
		msaaOff = "Off",
		msaaLow = "Low (2x)",
		msaaMedium = "Medium (4x)",
		msaaHigh = "High (8x)",
		tabAudio = "Audio",
		tabVideo = "Video",
