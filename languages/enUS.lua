return {
	...
	moduleDesc = {
		...
		poison_blight = "Poison stacks hit harder, but max stacks are lower. Better burst on elites and bosses.",
		poison_plague = "Poison stacks are weaker, but stack cap is much higher for long-path sustained scaling.",
