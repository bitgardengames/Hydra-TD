return {
	...
	ability = {
		meteor = {name = "Meteor", desc = "Damages every enemy in the targeted area."},
		frostNova = {name = "Frost Nova", desc = "Slows every enemy in the targeted area."},
		overdrive = {name = "Overdrive", desc = "Makes towers in the targeted area attack faster."},
		gravityWell = {name = "Gravity Well", desc = "Pulls enemies backward, then damages them when it ends."},
		goldRush = {name = "Gold Rush", desc = "Temporarily increases income from non-boss kills."},
		lastStand = {name = "Last Stand", desc = "Speeds up towers and readies volleys when enemies escape."},
		stats = {
			damage = "Damage",
			...
			heavyPull = "Boss/heavy pull",
			killIncome = "Kill income",
			bossIncome = "Boss kill income",
			volleys = "Escape volleys",
		},
		cooldown = "%s  %ds",
	},
	...
	campaign = {
		...
		rewards = {
			...
			strongest = "Strongest targeting option",
			weakest = "Weakest targeting option",
			enhancedPreview = "enhanced wave preview",
			plasma = "Plasma tower",
		...
		hints = {
			...
			gauntlet = "Use Strongest targeting to keep fire on the most durable threat.",
			...
			lowvalley = "Crack armored Bulwarks, then use Weakest targeting to finish survivors.",
			circuit = "Use the enhanced preview and focus wounded Regenerators before they recover.",
	...
	victory = {
		...
		rewardDescriptions = {
			targeting = "A new targeting priority is now available for every tower.",
			wave_preview = "Wave previews now reveal more information about incoming enemies.",
			ability_slot = "Equip and use both active abilities in the same run.",
			ability_upgrade = "Meteor and Frost Nova now use their enhanced effects.",
