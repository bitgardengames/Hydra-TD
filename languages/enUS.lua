return {
	...
	moduleDesc = {
		...
		cannon_siege_shells = "Uses larger blast radius shells for stronger area clears.",
		cannon_rapid_mortar = "Shrinks blast size and shell damage to support a faster barrage style.",
		cannon_cluster_payload = "Explosions release mini-shells that continue through nearby enemies.",
		cannon_shockwave = "Impacts launch a heavier knockback pulse around the blast center.",
		cannon_long_fuse = "Prioritizes enemies farthest from the tower to shell deeper lanes.",
		cannon_frontline_burst = "Prioritizes enemies furthest along the path to stop frontline leaks.",
		cannon_mega_shell = "Massive nuke shells with huge blast radius and amplified damage.",
		cannon_carpet_fire = "Each shot schedules two staggered follow-up shells for lane saturation.",
		cannon_seige = "Legacy id. Uses Siege Shells.",
		cannon_cluster = "Legacy id. Uses Cluster Payload.",
		cannon_aftershock = "Legacy id. Uses Shockwave.",
