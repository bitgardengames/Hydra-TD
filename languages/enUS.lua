return {
	...
	moduleDesc = {
		...
		slow_permafrost = "Applies slow and deals small splash damage on impact.",
		slow_frost_nova = "Hits create a static frost field that damages nearby enemies.",
		slow_shatterburst = "Hits on slowed enemies spawn frost shards that deal extra damage.",
		slow_cold_snap = "Targets low-HP enemies; killing a slowed enemy triggers an icy burst.",
		slow_black_ice = "Targets enemies farthest along the path; hits apply long slow and splash damage.",
		slow_absolute_zero = "Applies the strongest slow, adds shatter shards, and creates a larger static frost field.",
		slow_hailstorm = "Splits on hit and triggers extra burst damage on slowed enemies.",
