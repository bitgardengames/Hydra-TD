return {
	...
	campaign = {
		...
		hints = {
			...
			switchback = "Slow enemies where the switchback lanes overlap, then pierce the pack with Lancers.",
			highpass = "Place Cannons at bends so their blasts catch tightly packed grunts.",
			roundabout = "Keep Poison covering the loop so durable enemies stay afflicted.",
			gauntlet = "Combine control and splash, and save Meteor for a dangerous breakthrough.",
			snaketrail = "Slow fast enemies at segment exits and fire Lancers down the longest straight.",
			backtrack = "Focus Poison on the toughest targets while Cannons clear their escorts.",
			lowvalley = "Crack armored Bulwarks with heavy Cannon blasts instead of rapid small hits.",
			circuit = "Focus wounded Regenerators until they fall so they cannot recover.",
			outerloop = "Build overlapping kill zones and reserve abilities for runner leaks.",
			terrace = "Eliminate Warcallers first before their speed aura empowers the pack.",
			highridge = "Break barriers with Shock chains and concentrated Cannon bursts.",
			crossflow = "Use crossing lanes to cover shield, support, and regeneration threats together.",
