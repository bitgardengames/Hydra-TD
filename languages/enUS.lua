return {
	...
	moduleDesc = {
		...
		cannon_long_fuse = "Initial impact softens a medium area, then after a fixed delay triggers a heavier artillery detonation with a bonus damage ring.",
		cannon_frontline_burst = "Impact bursts into 3 short-range follow-up shells, stacking rapid multi-hit damage in tight frontline packs.",
		...
		shock_crowd_search = "Adds an extra chain jump and minor side-forks to raise multi-target damage output.",
