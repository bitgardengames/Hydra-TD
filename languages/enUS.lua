return {
	...
	moduleDesc = {
		...
		slow_glacier_core = "Each hit applies a heavy, long slow and deals bonus damage to slowed enemies.",
		...
		slow_frost_shards = "Each hit applies a light slow and spawns 1 shard shot.",
		slow_shatter = "Each hit applies a steady slow and deals extra damage to slowed enemies.",
		slow_snowball = "Shots pierce enemies, gain damage through crowds, and apply slow on hit.",
		slow_lead_freeze = "Each hit applies a heavy slow and gains major bonus damage vs slowed enemies.",
		slow_wide_chill = "Each hit applies chill and deals splash damage in a wider area.",
		slow_absolute_zero = "Each hit almost stops enemies, with lower follow-up damage.",
		slow_hailstorm = "Each hit applies a lighter slow and bursts into shard volleys for crowd damage.",
		lancer_overdrive = "Every 4th hit fires an overdrive round with +140% damage.",
		lancer_volley = "Each hit releases 2 follow-up split shots.",
		lancer_ricochet = "Shots bounce to a nearby enemy after impact.",
		lancer_sustained_barrage = "Fires in 6-shot cycles; the first 3 shots deal bonus damage.",
		...
		lancer_focus_fire = "Repeated hits on the same target within a short window build bonus rifle damage stacks.",
		...
		poison_corrupt_strong = "Each hit splashes poison to up to 2 nearby enemies, spreading stacks and duration.",
		...
		cannon_siege_shells = "Fires fewer, heavier shells with larger blasts and higher impact damage.",
		cannon_rapid_mortar = "Fires faster, lighter shells for better sustained splash in dense waves.",
		cannon_cluster_payload = "Shells split into 3 smaller bomblets on impact.",
		cannon_shockwave = "Impacts launch enemies, then emit a damaging shockwave for 2-stage AoE.",
		cannon_long_fuse = "Impact deals normal blast damage, then triggers a larger delayed blast with a bonus-damage ring.",
		cannon_frontline_burst = "Impact bursts into 3 short-range follow-up shells for stronger close-range splash.",
		...
		shock_crowd_search = "Adds extra chain jumps and stronger side-forks for much higher crowd damage.",
		shock_boss_focus = "Boosts repeated-hit surge damage and adds small endpoint bursts for heavy targets.",
		shock_thunderstorm = "Greatly extends chain reach and adds side-arcs for maximum crowd damage.",
		...
		plasma_thermal_tracking = "Extends plasma reach with a narrow burn trail for stronger long-lane damage.",
		plasma_lane_sweep = "Turns plasma into a volatile bloom that burns a much wider area at a faster tick rate.",
