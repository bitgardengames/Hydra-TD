return {
	...
	settings = {
		...
		displayModeDesc = "Choose between a resizable window, borderless desktop, or exclusive fullscreen.",
		displayModeWindowed = "Windowed",
		displayModeBorderless = "Borderless",
		displayModeFullscreen = "Fullscreen",
		monitor = "Monitor",
		monitorDesc = "Choose which monitor the game is displayed on.",
		monitorValue = "Monitor %d (%d × %d)",
		resolution = "Resolution",
		resolutionDesc = "Choose the window or exclusive fullscreen resolution. Borderless uses the desktop resolution.",
		resolutionValue = "%d × %d",
	...
	campaign = {
		...
		hints = {
			...
			lowvalley = "Use overlapping kill zones to manage mixed formations.",
	...
	enemy = {
		grunt = "Grunt",
		gruntDescription = "Balanced speed and health.",
		tank = "Tank",
		tankDescription = "Slow with high health.",
		runner = "Runner",
		runnerDescription = "Fast with low health.",
		regenerator = "Regenerator",
		regeneratorDescription = "Heals while not being attacked.",
		warcaller = "Warcaller",
		warcallerDescription = "Speeds up nearby enemies.",
		summoner = "Summoner",
		summonerDescription = "Periodically summons runners.",
		boss = "Boss",
		bossDescription = "Very high health.",
		bossSummoner = "Summoner",
		bossSummonerDescription = "Periodically summons enemies.",
		bossSuppression = "Suppressor",
		bossSuppressionDescription = "Periodically disables towers.",
		bossRavager = "Ravager",
		bossRavagerDescription = "Moves faster at low health.",
		...
		bossGatecrasherDescription = "Lunges forward at health thresholds.",
	},
