return {
	...
	moduleDesc = {
		...
		slow_glacier_core = "Each hit applies a heavy slow and deals bonus damage to slowed enemies.",
		...
		slow_wide_chill = "Each hit applies slow and deals splash damage in a wider area.",
		...
		lancer_focus_fire = "Repeated hits on the same target build bonus rifle damage stacks.",
		poison_blight = "Applies strong poison with a lower stack cap.",
		poison_plague = "Applies weaker poison per stack, but allows more stacks.",
		...
		poison_pandemic = "When a poisoned enemy dies, poison spreads to nearby enemies and can keep chaining.",
		cannon_siege_shells = "Fires fewer, heavier shells with bigger blasts and higher impact damage.",
		cannon_rapid_mortar = "Fires faster, lighter shells for better sustained splash damage.",
		...
		cannon_long_fuse = "Impacts deal normal blast damage, then trigger a larger delayed blast.",
